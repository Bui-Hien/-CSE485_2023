                        ...
                        <?php foreach ($ListCategory as $list) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='edit_category.php?id=<?= $list['ma_tloai'] ?>'><i class="fa-solid fa-pen-to-square"></i></a>
                                    <script>
                                        function myDelete() {
                                ...
                                <td>
                                    ...
                                    <a href='process_add_category.php?id=<?= $list['ma_tloai']?>' onclick="myDelete()" id="delete"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
